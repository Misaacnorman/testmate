...
import { SolidBlockCertificateData } from './SolidBlockCertificateData';
import QRCode from 'qrcode.react';

interface CertificateTemplateProps {
  data: SolidBlockCertificateData;
}

export const SolidBlockCertificateTemplate: React.FC<CertificateTemplateProps> = ({ data }) => {
    ...
    >
        ...
        <main>
            ...
            <div className="border-2 border-black mb-4">
                <h3 className="text-center font-bold py-1 bg-gray-200 border-b-2 border-black text-sm uppercase">Test Result for Solid Block</h3>
