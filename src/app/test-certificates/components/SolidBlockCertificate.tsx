...
interface SolidBlockCertificateProps {
    certificateData: BricksBlocksRegisterEntry;
    onBack: () => void;
}


export function SolidBlockCertificate({ certificateData, onBack }: SolidBlockCertificateProps) {
    ...
    React.useEffect(() => {
        const fetchAndMapData = async () => {
            ...
            const data: SolidBlockCertificateData = {
                ...
                sampleDescription: `${getSampleCountText(certificateData.sampleIds.length)} solid block(s) were delivered to the laboratory for testing`,
                ...
                sampleType: certificateData.solidBlockType || 'Not Specified',
        ...
        <>
            <div className="bg-card sticky top-0 z-10 print:hidden mb-4">
                <div className="flex h-16 items-center justify-between border-b px-4">
                    ...
                    <h2 className="text-lg font-semibold">Solid Block Certificate</h2>
