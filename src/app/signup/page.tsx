...
import { getRoles } from '@/app/admin/data';
import {
  Select,
  SelectContent,
  SelectItem,
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Leverage AI for anomaly detection and automated report
                  generation, turning data into decisions.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Monitor samples in real-time, from accession to analysis, with
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Generate comprehensive, compliant reports with the click of a
                  button, freeing up your valuable time.
                </p>
              </div>
            </div>
          </div>
