...
import { GroupedConcreteCubeSample, IssueCertificateData } from '@/lib/types';
...
export function IssueCertificateDialog({ open, onOpenChange, sampleSet, onSave }: IssueCertificateDialogProps) {
  ...
  const onSubmit = (data: IssueCertificateData) => {
    onSave(data);
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter final details for Receipt ID: {sampleSet.receiptId}
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 p-1">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Controller
                name="technician"
                control={form.control}
                render={({ field }) => <Input {...field} readOnly className="bg-muted/50" />}
              />
            </div>
             <div className="space-y-2">
          ...
          <DialogFooter className="pt-4">
            ...
            <Button type="submit">Save Certificate Details</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
