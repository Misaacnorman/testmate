...
import { GroupedPaverSample, PaverSample } from '@/lib/types';
...
interface EditSampleSetDialogProps {
  ...
  sampleSet: GroupedPaverSample;
  onSave: (data: Partial<GroupedPaverSample>) => void;
}
...
export function EditSampleSetDialog({ open, onOpenChange, sampleSet, onSave }: EditSampleSetDialogProps) {
  ...
  const handleSave = async () => {
    ...
    const finalData: Partial<GroupedPaverSample> = {
      ...data,
