...
type IssuanceBlocksAndBricksDialogProps = {
  items: BlockAndBrick[];
  onOpenChange: (open: boolean) => void;
  onBatchUpdate: (items: BlockAndBrick[]) => void;
};

export function IssuanceBlocksAndBricksDialog({ items, onOpenChange, onBatchUpdate }: IssuanceBlocksAndBricksDialogProps) {
