...
export const getColumns = (): ColumnDef<WaterAbsorption>[] => [
  ...
  },
  {
    ...
    header: () => <MultiLineHeader title="Oven Dried Weight Before soaking (kg)" />,
    cell: ({ row }) => <div>{row.getValue("ovenDriedWeightBeforeSoaking")}</div>,
  },
  {
    accessorKey: "weightAfterSoaking",
    header: () => <MultiLineHeader title="Weight After soaking (kg)" />,
    cell: ({ row }) => <div>{row.getValue("weightAfterSoaking")}</div>,
  },
  {
    accessorKey: "weightOfWater",
    header: () => <MultiLineHeader title="Weight of Water (kg)" />,
    cell: ({ row }) => <div>{row.getValue("weightOfWater")}</div>,
  },
  {
    accessorKey: "calculatedWaterAbsorption",
    header: () => <MultiLineHeader title="Calculated Water Absorption (%)" />,
    cell: ({ row }) => <div>{row.getValue("calculatedWaterAbsorption")}</div>,
  },
  {
