...
interface AddExperienceDialogProps {
    isOpen: boolean;
    onClose: () => void;
    onSave: (data: Omit<ProfileExperience, 'id'>, documents: File[]) => Promise<void>;
}
                    ...
                    <Form {...form}>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground mb-2">Upload certificates, contracts, or other work-related documents for this experience.</p>
                            </div>
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    onClick={() => document.getElementById('file-upload-experience')?.click()}
                                >
                                    Select Files
                                </Button>
                            </div>
