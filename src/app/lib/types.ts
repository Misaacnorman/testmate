...
export type CertificateStatus = 'Pending Engineer Approval' | 'Pending Technical Approval' | 'Approved' | 'Rejected';
...
export interface SampleTestResult {
  ...
  export interface BaseRegisterEntry {
    ...
    approvedByEngineer?: { uid: string; date: string; };
    approvedByManager?: { uid: string; date: string; };
